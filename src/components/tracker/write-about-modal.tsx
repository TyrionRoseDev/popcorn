	...
	return (
		<>
			<Dialog open={open} onOpenChange={onOpenChange}>
				...
				>
					<DialogTitle className="sr-only">Write About</DialogTitle>
								...
								{Array.from({ length: totalSteps }).map((_, i) => (
									<div
										...
										style={{
											...
											boxShadow:
												i <= stepIndex ? "0 0 6px rgba(0,229,255,0.5)" : "none",
										}}
									/>
								))}
							</div>
										...
										<div className="flex flex-col gap-1.5 max-h-[300px] overflow-y-auto scrollbar-hide">
											{seasonList.map((season) => (
												<button
													...
													type="button"
													onClick={() => handlePickSeason(season.seasonNumber)}
								...
								{step === "write-note" && (
									<>
										...
										<button
											...
											disabled={!note.trim() || createJournalEntry.isPending}
										...
										>
											{createJournalEntry.isPending ? "Saving..." : "Save Note"}
										</button>
									</>
								)}
